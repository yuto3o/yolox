...
def mosic(image, bboxes, labels,
    ...
    keep_idx, bboxes = keep_bbox_within(bboxes, (0, 0, cut_x, cut_y))
    keep_idx2, bboxes2 = keep_bbox_within(bboxes2, (cut_x, 0, w, cut_y))
    keep_idx3, bboxes3 = keep_bbox_within(bboxes3, (0, cut_y, cut_x, h))
    keep_idx4, bboxes4 = keep_bbox_within(bboxes4, (cut_x, cut_y, w, h))
